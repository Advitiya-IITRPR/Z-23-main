const Terms_and_Conditions = `Smoking, drinking and other drug consumption are strictly prohibited and necessary action will be taken by the institute if a participant or visitor is found to be in possession of these items.
